...
int hash_table_set(hash_table_t *hasht, const char *key, const char *value);
char *hash_table_get(const hash_table_t *hasht, const char *key);
void hash_table_print(const hash_table_t *hasht);
